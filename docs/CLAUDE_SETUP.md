...
2. That's it. The repo already contains a `.claude/commands/` folder with all 39 commands pre-built — Claude Code picks it up automatically, no copying required.
